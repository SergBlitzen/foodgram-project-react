...
def create_instance(
    ...
    связанной модели в виде словаря с ключами, являющимися названиями
    полей связанной модели, к значениям в виде объектов.
...
def delete_instance(model, message, objects) -> Response:
    ...
    :return Response: Респонс со статусом 204 или 400.
    """
